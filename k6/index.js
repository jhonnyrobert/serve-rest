...
export const options = {
  ...
  stages: [
    { duration: '1m', target: 100 }, // Rampa de subida para 100 VUs em 1 minutos
    { duration: '5m', target: 100 }, // Teste de carga constante com 100 VUs por 5 minutos
    { duration: '2m', target: 400 }, // Teste de pico constante com 400 VUs por 2 minutos
    { duration: '1m', target: 0 }, // Rampa de descida para 0 VUs em 1 minutos
  ],
  thresholds: {
